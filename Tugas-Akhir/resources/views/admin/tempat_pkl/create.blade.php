...
<div class="flex bg-gradient-to-br from-gray-100 to-blue-50 min-h-screen">
    ...
    <div class="flex-1 p-6">
        ...
        <h1 class="text-3xl font-bold mb-6 text-gray-800 flex items-center">
            <i class="fas fa-plus-circle text-blue-500 mr-3"></i> Tambah Tempat PKL
        </h1>
        ...
        <div class="bg-white rounded-xl shadow-xl p-8">
            <form action="{{ route('tempat_pkl.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_tempat" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm" required>
                </div>
                <div>
                    <label class="block font-semibold mb-2 text-gray-700 flex items-center">
                        <i class="fas fa-map-marker-alt mr-2 text-blue-500"></i> Alamat
                    </label>
                    <input type="text" name="alamat" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm" required>
                </div>
